...
public class CircleProgressBarView extends View {
    ...
    private boolean isShowAnimation;//是否需要动画
    private boolean isAutoAnimation;//是否需要自动播放动画【若用于recycerView中，应设置此属性为false，手动调用动画最佳】
    ...
    private void actionAnimation() {
        ...
        mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                setmCurrentProgressValue((int) value);
            }
        });
    ...
    private void setmCurrentProgressValue(int mCurPercent) {
        this.mCurrentProgressValue = mCurPercent;
        postInvalidate();
    }
